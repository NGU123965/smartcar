...
void F115_send_b1() {
    PORTCbits.RC3 = 1;
    _delay((unsigned long)((2000)*(32000000UL/4000000.0)));
    PORTCbits.RC3 = 0;
    _delay((unsigned long)((2000)*(32000000UL/4000000.0)));
}
...
void F115_send_b0() {
    ...
    _delay((unsigned long)((2000)*(32000000UL/4000000.0)));
    PORTCbits.RC3 = 0;
    _delay((unsigned long)((4000)*(32000000UL/4000000.0)));
}
...
void F115_header() {
    ...
    _delay((unsigned long)((2000)*(32000000UL/4000000.0)));
    PORTCbits.RC3 = 0;
    _delay((unsigned long)((6000)*(32000000UL/4000000.0)));
}
...
void F115_end() {
    ...
    _delay((unsigned long)((2000)*(32000000UL/4000000.0)));
    PORTCbits.RC3 = 0;
    _delay((unsigned long)((8000)*(32000000UL/4000000.0)));
    PORTCbits.RC3 = 1;
}
